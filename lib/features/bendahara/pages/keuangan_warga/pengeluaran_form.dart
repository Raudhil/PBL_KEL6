...
class PengeluaranFormPage extends ConsumerStatefulWidget {
  const PengeluaranFormPage({super.key});

  @override
  ConsumerState<PengeluaranFormPage> createState() => _PengeluaranFormPageState();
}

class _PengeluaranFormPageState extends ConsumerState<PengeluaranFormPage> {
  ...
  Future<void> _submit() async {
    ...
    final tx = KeuanganModel(
      title: title.isEmpty ? 'Pengeluaran' : title,
      amount: amount.abs(),
      type: 'Pengeluaran',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomTopBar(title: 'Tambah Pengeluaran', showBackButton: true, actions: [],),
      body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                style: TextStyle(color: AppColors.textPrimary),
                decoration: InputDecoration(
                  hintText: 'Contoh: Konsumsi acara RT',
                  hintStyle: TextStyle(color: AppColors.textPrimary),
                  filled: true,
                  fillColor: AppColors.white,
                ),
