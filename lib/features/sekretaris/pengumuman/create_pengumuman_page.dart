...
class CreatePengumumanPage extends ConsumerStatefulWidget {
  const CreatePengumumanPage({super.key});

  @override
  ConsumerState<CreatePengumumanPage> createState() =>
      _CreatePengumumanPageState();
}

class _CreatePengumumanPageState extends ConsumerState<CreatePengumumanPage> {
  final _formKey = GlobalKey<FormState>();
  final _judulController = TextEditingController();
  final _isiController = TextEditingController();
  final _fotoUrlController = TextEditingController();
  final _dokumenUrlController = TextEditingController();
          ...
          SnackBar(
            content: Row(
              children: [
                const Icon(Icons.error_outline, color: Colors.white),
                const SizedBox(width: 12),
                Expanded(child: Text('Gagal membuat: ${e.toString()}')),
              ],
            ),
            backgroundColor: Colors.red.shade600,
            behavior: SnackBarBehavior.floating,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Pengumuman berhasil dibuat dan sudah tersimpan di sistem.',
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(
                  formState.isLoading ? 'Menyimpan...' : 'Simpan Pengumuman',
